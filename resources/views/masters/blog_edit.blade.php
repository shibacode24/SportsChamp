        ...
        <table width="80%">
            ...
            <tr>
                <td style="padding: 2px;" width="1%">
                    <input type="date" class="form-control" name="date" value="{{$blog_edit->date}}" placeholder="" />
                    </div>
                </td>
                <td style="padding: 2px;" width="2%">
                    <input type="text" class="form-control" name="title" value="{{$blog_edit->title}}" placeholder="" />
                </td>
                <td style="padding: 2px;" width="1%">
                    <input type="text" class="form-control" name="author_name" value="{{$blog_edit->author_name}}" placeholder="" />
                </td>
                <td style="padding: 2px;" width="1%">
                    <input type="file" class="form-control" name="image" value="{{$blog_edit->image}}" placeholder="" />
                </td>
            ...
            {{-- <tr>
                <td style="padding: 2px;" width="40%">
                 <textarea class="form-control" id="editor" placeholder="content"
                    name="content">{{$blog_edit->content}}</textarea>
                </td>
                
            </tr> --}}
            <tr style="height:30px;">
                <td style="padding: 2px;" width="2%">
            <div id="editor-container" style="height: 150px;">{!! $blog_edit->content !!}</div>
