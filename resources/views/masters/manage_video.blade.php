...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="margin-top: 2vh;">
            <form action="{{ route('manage_video_store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <table width="100%">
                    ...
                    <tbody>
                        @foreach ($video as $videos)
                            <tr>
                                ...
                                <td>{{ $videos->title }}</td>
                                <td>
                                    <a href="{{ asset('images/video_image/' . $videos->video_image) }}" target="_blank">
                                        <img src="{{ asset('images/video_image/' . $videos->video_image) }}" width="50"
                                            height="50" />
                                    </a>
                                ...
                                <td>
                                    <a href="{{ route('manage_video_edit', $videos->id) }}">
                                        <button
                                    ...
                                    <button onclick="openCustomModal('{{ route('manage_video_destroy', $videos->id) }}')"
                                        id="customModal"
